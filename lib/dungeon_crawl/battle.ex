defmodule DungeonCrawl.Battle do
  ...
  def fight(char_a, char_b) do
    char_b_after_damaged = attack(char_a, char_b)
    char_a_after_damaged = attack(char_b_after_damaged, char_a)

    fight(char_a_after_damaged, char_b_after_damaged)
  end
  ...
  defp attack(char_a, char_b) do
    ...
    char_b_after_damaged = Character.take_damage(char_b, damage)

    char_a
      |> attack_message(damage)
      |> Shell.info

    char_b_after_damaged
